    ...
    if(props.videoItm.speaker){
        return(
            <Link href={{
                ...
                <Pressable>
                    <StyledView className='mb-4 ml-4 mr-2'>
                        ...
                        <StyledText className='w-48 mt-2 ml-4 text-base text-white font-bold italic'>{props.videoItm.title}</StyledText>
                        <StyledText className='w-48 ml-3 text-sm text-white italic' numberOfLines={1}>{`${props.videoItm.speaker}`}</StyledText>
                    </StyledView>
                </Pressable>
            </Link>
        );
