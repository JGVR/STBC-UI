...
export default function BgImageScreenHeader(props: {router: any, imageUrl: string, thumbNailUrl: string, buttonTitle: string, headerTitle: string, headerOptionalMsg: string|null, containerLayout: ComponentLayout, subContainerLayout: ComponentLayout, backButtonLayout: ComponentLayout|any, backIconLayout: ComponentLayout|any, backButtonShown: boolean, imageLayout: ComponentLayout, thumbnailLayout: string, titleLayout: ComponentLayout, optionalMsgLayout: ComponentLayout}){
    return(
        <StyledView className={`
            ...
            <StyledView className={`${props.subContainerLayout.height} ${props.subContainerLayout.width} ${props.subContainerLayout.top}`}>
                ...
                {props.thumbNailUrl ? <StyledImage className={props.thumbnailLayout} src={props.thumbNailUrl}/> : null}
