...
const imageLayout = new ComponentLayout({height: "h-40", width: "w-96", left:"ml-5", border:"border rounded-2xl"});
const titleLayout = new ComponentLayout({height:"", width:"w-52", top:"mt-5", bottom:"mb-3", size:"text-lg", color:"text-white"});
const mailHeaderLayout = new ComponentLayout({height: "h-6", width:"w-8", top:"-mt-48", left:"ml-96", color:"white"});
const iconLayout = new ComponentLayout({height:"", width:"", top:"mt-6", left:"ml-3", color:"white"});
const buttonLayout = new ComponentLayout({height:"", width:"", top:"mt-4", left:"-ml-2", color:"white"});
