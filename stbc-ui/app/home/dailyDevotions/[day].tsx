    ...
    if(isCompleted){
        return(
            <StyledView className='h-[100%]'>
                <BgImageScreenHeader router={router} buttonTitle='Devotions' headerTitle={devotions.length > 0 ? devotions[1]["title"] : ""} headerOptionalMsg={devotions.length > 0 ? devotions[1]["memberId"] : null} containerLayout={containerLayout} backButtonLayout={buttonLayout} backIconLayout={iconLayout} backButtonShown={true} imageLayout={imageLayout} titleLayout={titleLayout} optionalMsgLayout={optionalMsgLayout}/>
